...
class TestIntegration:
    ...
    def test_complete_monitoring_workflow(self, mock_post, mock_github_class,
                                        sample_config, sample_issues, mock_github_token):
    ...
    @patch('monitor_github_notify.Github')
    def test_no_new_issues_workflow(self, mock_github_class, sample_config, mock_github_token):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('monitor_github_notify.requests.post') as mock_post, \
                ...
                assert not any('new_issues.json' in str(call) for call in mock_open.call_args_list)

    @patch('monitor_github_notify.Github')
    def test_duplicate_issue_filtering(self, mock_github_class, sample_config, mock_github_token):
...
class TestErrorHandling:
    ...
    @patch('monitor_github_notify.Github')
    def test_github_api_error_handling(self, mock_github_class, sample_config, mock_github_token):
    ...
    @patch('monitor_github_notify.Github')
    @patch('monitor_github_notify.requests.post')
    def test_slack_error_handling(self, mock_post, mock_github_class, sample_config, mock_github_token):
